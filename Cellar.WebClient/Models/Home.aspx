<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="Cellar.WebClient.Empresas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- third party js -->
    <script src="https://coderthemes.com/hyper/assets/js/vendor/Chart.bundle.min.js"></script>
    <script src="https://coderthemes.com/hyper/assets/js/vendor/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="https://coderthemes.com/hyper/assets/js/vendor/jquery-jvectormap-world-mill-en.js"></script>
    <!-- third party js ends -->

    <!-- demo app -->
    <script src="https://coderthemes.com/hyper/assets/js/pages/demo.dashboard.js"></script>
    <!-- end demo js-->
