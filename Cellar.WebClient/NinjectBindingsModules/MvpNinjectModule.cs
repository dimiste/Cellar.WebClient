...
namespace Cellar.WebClient.NinjectBindingsModules
{
    public class MvpNinjectModule : NinjectModule
    {
        public override void Load()
        {
            ...
            this.Bind<IPresenter>().ToMethod(this.GetPresenterFactoryMethod).NamedLikeFactoryMethod((ICustomPresenterFactory factory) => factory.GetPresenter(null, null));
