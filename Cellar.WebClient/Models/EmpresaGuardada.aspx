<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmpresaGuardada.aspx.cs" Inherits="Cellar.WebClient.Models.EmpresaGuardada" %>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    ...
                                    <h4 class="text-uppercase text-success mt-3">Empresa Insertada con Exito</h4>
                                    

                                    <a class="btn btn-info mt-3" href="Home.aspx"><i class="mdi mdi-reply"></i>Inicio</a>
                                    <a class="btn btn-info mt-3" href="InsertarEmpresa.aspx"><i class="mdi mdi-reply"></i>Insertar Empresa</a>
                                </div>
                            </div>
                            <!-- end card-body-->
                        </div>
